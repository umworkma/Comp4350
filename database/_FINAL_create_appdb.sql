...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='Physical address of an entity.';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='Simple contact types for entities such as email or telephone.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entity` (
  ...
  PRIMARY KEY (`pk`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='Represents a person or organization, and is used to link addresses and contact methods to people and organizations.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1 COMMENT='An event held by one or more organizations which require workers to work shifts in a schedule.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `privilege` (
  ...
  PRIMARY KEY (`pk`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1 COMMENT='Lookup table of all application privileges.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1 COMMENT='Links privileges with specific individuals, allowing that individual to puse the given privilege. If an organization is not attached, then the privilege is global, but this is only valid if the feature that uses the privilege bahaves in that manner.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1 COMMENT='A timeframe within an event that requires workers to work together on some task.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1 COMMENT='Bridging table for many-to-many relationship between Person and Shift. More than one person can work on one shift, and a person can work on more than one shift.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-03-24 16:03:40
